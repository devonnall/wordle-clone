...
export default function SignUp() {
    ...
    return (
        <div className="flex sm:items-center justify-center h-screen">
            ...
            <div className="relative flex flex-col mx-auto p-2 sm:aspect-[18/9] w-4xl sm:bg-white sm:dark:bg-neutral-900 rounded-3xl">
                ...
                <div className="absolute top-48 right-2 left-2 h-screen flex flex-col items-center bg-neutral-900 rounded-t-3xl">
